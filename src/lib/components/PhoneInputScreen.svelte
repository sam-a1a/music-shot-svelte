    ...
    >
        <div class="mb-2 flex items-center justify-between gap-1">
            <GithubRepoButton
                    ...
                    className="h-6 inline-flex items-center gap-1.5 rounded-lg border border-white/20 bg-white/10 px-2 text-xs font-semibold text-white transition-colors hover:bg-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
        ...
        <div>
            ...
            <input
                    ...
                    name="album-url"
                    autocomplete="off"
                    placeholder="Paste album link here..."
                    disabled={loading}
