...
<div
        bind:this={rootRef}
        class="relative h-full w-full overflow-x-hidden overflow-y-auto font-body [scrollbar-width:none] [&::-webkit-scrollbar]:hidden {resultScreenThemeClass} {exportRenderMode ? '[&_*]:transition-none' : ''}"
>
                        ...
                        <div class="w-6 text-center">
                            <div class="flex items-end justify-center gap-0.5 h-4">
                                <div
                                        ...
                                        style="background-color: {resolvedAccentColor}"
                                ></div>
                                <div
